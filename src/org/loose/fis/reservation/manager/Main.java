...
public class Main {
    ...
    */
    public static void main(String[] args) {
        ...
        List<Reservation> reservation=createReservations(user1, user2, user3, user4);
        
        reservations.forEach(System.out::println);
    }
    public static List<Reservation> createReservations(User user1, User user2, User user3, User user4){
